  ...
  return (
    <>
        <div className="w-full h-[7%] flex items-center">
            <p className="font-black text-[1vw]">{featured && featured[0].type === "hoodie" ? "FEATURED HOODIES" : featured && featured[0].type === "tee" ? "FEATURED T-SHIRTS" : featured && featured[0].type === "accessory" ? "FEATURED ACCESSORIES" : featured && featured[0].type === 'bottom' ? "FEATURED BOTTOMS" : "FEATURED"}</p>
        </div>
        <div className="w-full h-[93%] border border-gray-200 flex">
            <div className="w-1/4 h-full border-r border-gray-200 relative flex justify-center pt-5">
                ...
                <div className="absolute bottom-2 left-3 flex flex-col">
                    <p className="text-[0.8vw] font-black cursor-pointer hover:underline uppercase">{featured && featured[0].name}</p>
                    <p className="text-[0.7vw] font-light uppercase">{featured && featured[0].price}</p>
                    <div className="border-black rounded-full">
                        <p className={`font-extrabold text-[0.6vw] ${featured && featured[0].type === "bottom" ? "opacity-0" : "opacity-100"}`}>SELLING FAST</p>    
                    </div>
                </div>
            </div> 
            <div className="w-1/4 h-full border-r border-gray-200 relative flex justify-center pt-5">
            ...
            <div className="w-1/4 h-full flex flex-col items-center justify-center cursor-pointer">
                <p className="font-black text-[1.1vw] text-center uppercase">{featured && featured[0].type === "hoodie" ? "SHOP ALL HOODIES" : featured && featured[0].type === "tee" ? "SHOP ALL T-SHIRTS" : featured && featured[0].type === "accessory" ? "SHOP ALL ACCESSORIES" : featured && featured[0].type === 'bottom' ? "SHOP ALL BOTTOMS" : "SHOP ALL"}</p>
